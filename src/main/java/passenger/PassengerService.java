...
public class PassengerService {
    ...
    public void enterId(){
        ...
        if (passenger == null){
            System.out.println("Cannot find main.java.passenger with that Id");
            chooseIdOrName();
        } else {
    ...
    public void enterName(){
        ...
        if (filteredList.size() == 0){
           ...
           int option =  Interface.getOption("Choose a main.java.passenger from the list below:", arr);

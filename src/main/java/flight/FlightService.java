...
import main.java.passenger.Passenger;
...
public class FlightService {
    ...
    public void checkPassengerFlights(Passenger passenger){
        ...
        System.out.println("Flights for main.java.passenger: " + passenger.getName());
        if (onboard.size() > 0){
    ...
    public void cancelFlight(){
        displayAllFlights();
        System.out.println("Enter main.java.flight code to cancel:");
        Scanner scanner = new Scanner(System.in);
    ...
    public void bookOrDisplay(Passenger p){
        String[] options = {"Book a main.java.flight for " + p.getName(), "Display booked flights for " + p.getName()};
    ...
    public void findAvailableFlights(Passenger p){
        ...
        if (availableFlights.size() == 0){
            ...
            int option = Interface.getOption("Pick an available main.java.flight below:", arr);
